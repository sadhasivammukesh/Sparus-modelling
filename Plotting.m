...
T = (1:size(PosE_S,1)) * 0.01;

% Plot Velocities
figure(1);
set(gcf, 'Name', 'Body Frame Linear Velocities over Time', 'NumberTitle', 'off');
subplot(2,1,1);
plotData(T, VitB_S(:,1:3), {'surge', 'sway', 'heave'}, 'Linear Velocity', 'v [m/s]');
subplot(2,1,2);
plotData(T, 180*VitB_S(:,4:6)/pi, {'roll', 'pitch', 'yaw'}, 'Angular Velocity', 'omega [deg/s]');
